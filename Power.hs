...
stepsPower _ 0 = 1
stepsPower n k
  | even k    = 1 + stepsPower (n * n) (k `div` 2)
  | otherwise = 1 + stepsPower n (k - 1)        
...
stepsPower2 :: Integer -> Integer -> Integer
stepsPower2 _ 0 = 0
stepsPower2 n k
  | even k    = 1 + stepsPower2 (n * n) (k `div` 2)
  | otherwise = 1 + stepsPower2 n (k - 1)
